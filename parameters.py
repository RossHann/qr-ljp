...
def parse():
    ...
    parser.add_argument("--train_datapath", type=str, default="./data/tokenized_data/small_train.pkl")
    parser.add_argument("--valid_datapath", type=str, default="./data/tokenized_data/small_valid.pkl")
    parser.add_argument("--test_datapath", type=str, default="./data/tokenized_data/small_test.pkl")
    parser.add_argument("--model_savepath", type=str, default="./pts/tca_ljp_model")
